...
| P1-3 | P1 | Provision first admin | `scripts/provision-admin.mjs`, `supabase/migrations/010_secure_admin_provisioning.sql` (`provision_admin()`) | `npm run provision-admin <email>` after migrations |
